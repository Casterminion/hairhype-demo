...
-- Only admins with valid sessions can view admin users
...
-- Public can verify sessions (needed for auth check)
...
BEGIN
  ...
  -- If 5 or more failed attempts in last minute, block
  IF v_failed_attempts >= 5 THEN
    -- Check if minute has passed since last attempt
